...
**/
	...
	if(RootPtr == NULL) {
		...
		//pokracovanie do praveho podstromu
		if(RootPtr->Key < K) {
				return BSTSearch(RootPtr->RPtr, K, Content);
		}
		//pokracovanie do laveho podstromu
...
**/
	...
	//hladanie najpravejsieho prvku
	if((*RootPtr)->RPtr != NULL) {
		ReplaceByRightmost(PtrReplaced, &(*RootPtr)->RPtr);
	}
	//nahradenie a vymazanie
	else {
...
**/
	...
	if(*RootPtr == NULL) 
		return;
	//priechod do laveho a prraveho podstromu
